...
if { $form_posted } {
    ...
    switch -exact -- $mode {
        e {
            ...
            set validated 1
            if { ![ecds_is_natural_number $initial_conditions_tid] && ![ecds_is_natural_number $sales_curve_tid] } {
                set mode "n"
                set next_mode ""
            } 
        }
        d {
            ...
            set validated 1
            if { ( ![ecds_is_natural_number $initial_conditions_tid] && ![ecds_is_natural_number $sales_curve_tid] ) || !$delete_p } {
                set mode "p"
                set next_mode ""
            } 
        }
        ...
        c {
            ...
            if { ![ecds_is_natural_number $sales_curve_tid] } {
    ...
    if { $validated } {
        ...
        if { $mode eq "t" } {
            ...
            #requires initial_conditions_tid or sales_curve_tid
            # delete initial_conditions_tid or sales_curve_tid or both, if both supplied
            if { [ecds_is_natural_number $sales_curve_tid] && $write_p } {
            ...
            if { [ecds_is_natural_number $initial_conditions_tid] && $write_p } {
...
#                ns_log Notice "app-model.tcl i $i last_row $last_row row_step $row_step ii $ii"
        ...
        foreach price $price_list {
            ...
            set row_list [list [lindex $price_label_list $price_idx] [ec_pretty_price $price] $frequency_orig ]
            foreach i $intervals_list {
    ...
    v {
        ...
        if { [ecds_is_natural_number $initial_conditions_tid] && [ecds_is_natural_number $sales_curve_tid] && $write_p } {
        ...
        if { [ecds_is_natural_number $sales_curve_tid] } {
            ...
            if { !$menu_e_p && ![ecds_is_natural_number $initial_conditions_tid] && $write_p } {
